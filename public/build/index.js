...
var _Characters = __webpack_require__(/*! ./Characters */ "./src/Characters.js");

var _Characters2 = _interopRequireDefault(_Characters);

var _CharacterDetails = __webpack_require__(/*! ./CharacterDetails */ "./src/CharacterDetails.js");
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: "/", component: _Characters2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: "/character/:id", component: _CharacterDetails2.default })
    )
  );
};
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: "/character/" + this.props.infos.id },
...
var _Character = __webpack_require__(/*! ./Character */ "./src/Character.js");
...
var CharacterDetails = function (_React$Component) {
  _inherits(CharacterDetails, _React$Component);

  function CharacterDetails(props) {
    _classCallCheck(this, CharacterDetails);

    var _this = _possibleConstructorReturn(this, (CharacterDetails.__proto__ || Object.getPrototypeOf(CharacterDetails)).call(this, props));

    console.log(props);
    _this.state = {
      details: null
    };
    _this.getCharacterDetailsFromApi();
    return _this;
  }

  _createClass(CharacterDetails, [{
    key: 'getCharacterDetailsFromApi',
    value: function getCharacterDetailsFromApi() {
      var _this2 = this;

      _axios2.default.get('/api/characters/' + this.props.match.params.id).then(function (response) {
        _this2.setState({
    ...
    value: function render() {
      ...
      if (this.state.details === null) return _react2.default.createElement(
        'div',
        null,
        'loading...'
      );
...
var Characters = function (_React$Component) {
  ...
  _createClass(Characters, [{
    ...
    value: function getCharactersFromApi() {
      ...
      _axios2.default.get('/api/characters').then(function (response) {
        _this2.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.characters.map(function (character) {
          return _react2.default.createElement(_Character2.default, { infos: character, key: 'character' + character.id });
        })
      );
    }
  }]);
